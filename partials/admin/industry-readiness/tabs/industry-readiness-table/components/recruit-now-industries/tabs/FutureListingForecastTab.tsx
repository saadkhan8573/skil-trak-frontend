...
export const FutureListingForecastTab = ({
    forecast,
    isOpen,
    setSelectedPartner,
    selectedPartner,
    ...
    const { data, isLoading, isError } =
        AdminApi.IndustryReadiness.useForecastFutureIndustriesList(
            {
    ...
    return (
        <div>
            ...
            <FutureIndustryDetailPanelModal
