...
import { MultiAcceptModal as MultiUnblockModal } from './modals'
...
export const BlockedIndustry = () => {
    ...
    const { columns } = getTableConfig({
        ...
        actionKeys: ['view', 'edit', 'viewPassword', 'unblock', 'delete'],
    })
    ...
    const onMultiUnblockClicked = (industries: Industry[]) => {
        setModal(
            <MultiUnblockModal
    ...
    const quickActionsElements = {
        ...
        common: (industries: Industry[]) => (
            <div className="flex gap-x-2">
                <ActionButton
                    onClick={() => {
                        onMultiUnblockClicked(industries)
                    }}
                    variant="warning"
                >
                    Unblock
