...
> = ({
    ...
    return (
        ...
        >
            <div
                className={`p-4 border-b border-gray-100 ${config?.bg} ${config?.bgHover} cursor-pointer transition-all flex items-center justify-between group`}
            ...
            >
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-[13px] text-muted-foreground font-medium opacity-80 mt-0.5">
                            {config?.description}
                        </p>
                    </div>
                </div>
