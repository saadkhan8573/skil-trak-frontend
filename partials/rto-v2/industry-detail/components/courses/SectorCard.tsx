...
const sectorStatusColorMap: Record<string, string> = {
    approved: 'bg-linear-to-r from-[#10B981] to-[#059669]',
    rejected: 'bg-linear-to-r from-red-500 to-red-700',
    pending: 'bg-linear-to-r from-[#F7A619] to-[#EA580C]',
    removed: 'bg-linear-to-r from-slate-500 to-slate-700',
}
...
export function SectorCard({
    ...
    const isDeletedInternal =
        isDeleted || !!sector.sector.deletedAt || !!industryApproval?.deletedAt
                        ...
                        <div className="flex-1">
                            <div className="flex items-center gap-2 mb-1">
                                        ...
                                        <>
                                            ...
                                            >
                                                ...
                                                <motion.button
                                                    ...
                                                    onClick={(e) => {
                                                        e.stopPropagation()
                                                        setShowSupervisorsModal(
                                                            true
                                                        )
                                                    }}
                                                    className="px-2.5 py-1.5 bg-linear-to-br from-[#044866] to-[#0D5468] text-white rounded-full text-[10px] font-bold flex items-center gap-1.5 shadow-md hover:shadow-lg transition-all"
                                            ...
                                            {/* {initiatedESign &&
                                                !hasPendingActions && (
                                                    <motion.button
                                                        ...
                                                        onClick={(e) => {
                                                            e.stopPropagation()
                                                            setShowCancelEsignModal(
                                                                true
                                                            )
                                                        }}
                                                        className="px-3 py-1.5 bg-linear-to-r from-red-500 to-rose-600 text-white rounded-full text-[10px] font-bold flex items-center gap-1.5 shadow-lg shadow-red-500/20 hover:shadow-red-500/40 transition-all border border-red-400/30"
                                                        title="Cancel E-sign"
                                                    >
                                ...
                                {hasPendingActions && !sectorApproved && (
                                    <div className="px-2.5 py-1 bg-linear-to-r from-[#F7A619] to-[#EA580C] text-white rounded-full text-[10px] font-bold flex items-center gap-1 shadow-md animate-pulse">
