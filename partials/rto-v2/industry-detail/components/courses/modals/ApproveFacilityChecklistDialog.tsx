                ...
                <DialogContent className="max-w-2xl">
                    <DialogHeader>
                        <div className="flex items-center gap-3 mb-2">
                            <div className="w-12 h-12 bg-linear-to-br from-[#044866] to-[#0D5468] rounded-xl flex items-center justify-center">
                    ...
                    <div className="space-y-4">
                        {/* Status Banner */}
                        <div className="bg-linear-to-r from-[#10B981]/10 to-[#059669]/10 border border-[#10B981]/20 rounded-lg p-4">
                            <div className="flex items-start gap-3">
                                <div className="w-10 h-10 bg-linear-to-br from-[#10B981] to-[#059669] rounded-lg flex items-center justify-center shrink-0">
                        ...
                        <div className="flex items-center gap-3 pt-2">
                            <Button
                                ...
                                className="flex-1 bg-linear-to-r from-[#10B981] to-[#059669] hover:from-[#059669] hover:to-[#047857] text-white gap-2 h-10"
                            >
