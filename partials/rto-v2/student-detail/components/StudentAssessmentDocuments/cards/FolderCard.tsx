...
import { AssessmentEvidenceFolder, FolderStatusConfig, Student } from '@types'
...
export const FolderCard = ({
    ...
    const isAllFilesStatusChanged = responseFiles
        ?.filter((file) => !file?.isArchived)
        ?.every((file: any) => file?.status !== 'pending')
                        ...
                        <div className="flex-1">
                            <div className="flex items-center gap-3 mb-1">
                                ...
                                {response?.filesCount > 0 &&
                                    ...
                                    response?.status === Result.Pending &&
