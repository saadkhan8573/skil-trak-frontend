                        ...
                        <div className="bg-white rounded-2xl p-6 border border-slate-100 shadow-sm space-y-4">
                            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                                ...
                                <div className="flex flex-col items-end gap-2">
                                    <div
                                        className={`px-4 py-1.5 rounded-full border text-xs font-bold uppercase tracking-wider flex items-center gap-2 ${
                                            getResultStatus(
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                {selectedResult?.comments?.map(
                                    (comment: any) => {
                                        const status = getFolderStatusInfo(
                                            comment?.status
                                        )
                                        return (
                                            <motion.div
                                            ...
                                            >
                                                <div className="flex items-start gap-4">
                                                    <div
                                                        className={`mt-1 p-2 rounded-lg ${status.bg} ${status.color}`}
                                                    >
                                                        {status.icon}
                                                    </div>
                                                    <div className="flex-1 space-y-1">
                                                        ...
                                                        <p className="text-xs text-slate-500 leading-relaxed">
                                                            {comment?.comment ||
                                                                'No specific notes provided for this section.'}
                                                        </p>
                                                    </div>
                                                </div>
                                            </motion.div>
