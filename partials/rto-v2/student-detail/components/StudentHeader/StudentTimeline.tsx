            ...
            {studentDetail?.oldExpiry && (
                <div className="mt-2 pt-2 border-t border-[#044866]/10 flex gap-2">
                    <div className="flex-1 bg-slate-100 rounded-md p-2">
                        <p className="text-[10px] text-slate-600 mb-0.5">Original Deadline</p>
                        <p className="text-xs font-semibold text-slate-900">
                            {moment(studentDetail.oldExpiry).format('MMM D, YYYY')}
                        </p>
                    </div>
                    <div className="flex-1 bg-gradient-to-br from-emerald-50 to-emerald-100/50 rounded-md p-2 border border-emerald-200/50">
                        <p className="text-[10px] text-emerald-700 mb-0.5">Extended To</p>
