                ...
                <DialogHeader className="relative bg-linear-to-r from-orange-500 to-orange-600 px-6 py-4 rounded-t-2xl overflow-hidden space-y-0">
                    ...
                    <div className="relative flex items-center gap-3">
                        ...
                        <div className="text-left">
                            <DialogTitle className="text-xl font-bold text-white">Reject Placement Request</DialogTitle>
                            <p className="text-orange-100 text-sm mt-0.5">This action requires confirmation</p>
                        </div>
                    </div>
                </DialogHeader>
                ...
                <div className="p-6 space-y-4">
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1">
                                ...
                                <ul className="mt-2 space-y-1 text-xs text-orange-800">
                                    ...
                                    <li className="flex items-start gap-2">
                                        <span className="text-orange-500 mt-0.5">•</span>
                                        <span>The request will be marked as <strong>rejected</strong></span>
                                    </li>
                                    <li className="flex items-start gap-2">
                                        <span className="text-orange-500 mt-0.5">•</span>
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            rows={4}
                            className="w-full px-4 py-3 text-sm border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent resize-none placeholder:text-slate-400"
                        />
