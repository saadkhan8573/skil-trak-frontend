...
export const PlacementStarted = () => {
    ...
    const [downloadReport, downloadState] =
        RtoV2Api.Students.useDownloadPlacementStartedStudent()
    ...
    const { isLoading, data, isError } =
        RtoApi.Students.usePlacementStartedStudentsList({
            ...
            <div className="flex flex-col gap-y-3">
                <Card noPadding>
                    ...
                    {isLoading ? (
                        ...
                        !isError && (
                            <EmptyData
                                title={'No Placement Started Students!'}
                                description={
                                    'You have no students with started placements'
                                }
                                height={'50vh'}
                            />
                        )
