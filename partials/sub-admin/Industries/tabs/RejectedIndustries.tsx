...
interface RejectedIndustriesProps {
    baseFilter: any
}

export const RejectedIndustries: React.FC<RejectedIndustriesProps> = ({
    baseFilter,
}) => {
        ...
        <div className="space-y-4">
            ...
            <Card noPadding>
                ...
                {industries?.isLoading || industries?.isFetching ? (
                    ...
                    !industries?.isError && (
                        <EmptyData
                            title={'No Rejected Industries!'}
                            description={'No rejected industries found.'}
                            height={'50vh'}
                        />
                    )
                )}
