...
export function TopBarSkeleton() {
    return (
        <div
            ...
            className="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-6 shrink-0"
        >
...
export function SubAdminNavbarSkeleton() {
    return (
        ...
        >
            <div
                suppressHydrationWarning
                className="flex gap-x-2 w-full overflow-hidden"
            >
                {[1, 2, 3, 4, 5, 6].map((i) => (
                    <div
                        suppressHydrationWarning
            ...
            <div
                suppressHydrationWarning
                className="flex gap-x-2 items-center shrink-0 ml-4"
            >
        ...
        >
            ...
            >
                <div suppressHydrationWarning className="flex gap-x-2">
                    <div
                        suppressHydrationWarning
                        className="flex-1 p-2 bg-gray-50 rounded border border-gray-100"
                    >
            ...
            <div
                suppressHydrationWarning
                className="flex flex-col gap-y-3 w-full flex-1"
            >
                <div
                    suppressHydrationWarning
    ...
    return (
        ...
        >
            ...
            <div suppressHydrationWarning className="flex flex-col gap-y-6">
                <div
                    suppressHydrationWarning
                    className="flex gap-x-6 w-full items-start"
                >
                    {/* Left Column: Stats Grid */}
                    <div
                        suppressHydrationWarning
                        className="w-1/2 grid grid-cols-2 gap-x-4 gap-y-6"
                    >
                        {[1, 2, 3, 4, 5, 6].map((i) => (
                            <div
                                suppressHydrationWarning
                    ...
                    <div suppressHydrationWarning className="w-1/2">
                        <div
                            suppressHydrationWarning
                            className="bg-white rounded-xl border border-slate-200 shadow-sm p-6 h-112.5"
                        >
                            <Skeleton className="h-6 w-40 mb-8" />
                            <div
                                suppressHydrationWarning
                                className="flex items-center justify-center h-75"
                            >
                ...
                <div
                    suppressHydrationWarning
                    className="w-full h-125 flex gap-x-4"
                >
                    <div
                        suppressHydrationWarning
                        className="w-2/5 h-full bg-white rounded-xl border border-slate-200 shadow-sm p-4"
                    >
                        <div
                            suppressHydrationWarning
                    ...
                    <div
                        suppressHydrationWarning
                        className="w-3/5 h-full bg-slate-200 rounded-xl animate-pulse"
                    >
                        {/* Map Placeholder */}
                    </div>
                </div>
    ...
    return (
        ...
        >
            ...
            >
                ...
                <div
                    suppressHydrationWarning
                    className="flex-1 flex flex-col h-full overflow-y-auto remove-scrollbar"
                >
