...
const {
    ...
    useListByStatusForRtoQuery,
    useUsersReadyToSignDocumentsListQuery,
    ...
    useGetRtosAllowedForTeamQuery,
    useGetRtosCoordinatorAllowedForTeamQuery,
    useEditSupportTeamMutation,
    useGetAllSupportTeamsQuery,
    useDeleteSupportTeamMutation,
    useUpdateCanReceiveTicketsMutation,
...
export const CommonApi = {
    ...
    ESign: {
        ...
        bulkInitiateIndustryESign: useBulkInitiateIndustryESignMutation,
        ...
        useListByStatusForRto: useListByStatusForRtoQuery,
        useReadyToSignDocumentsList: useUsersReadyToSignDocumentsListQuery,
    ...
    Teams: {
        ...
        useRtosAllowedForTeam: useGetRtosAllowedForTeamQuery,
        useRtosCoordinatorAllowedForTeam:useGetRtosCoordinatorAllowedForTeamQuery,
        ...
        useUpdateCanReceiveTickets: useUpdateCanReceiveTicketsMutation,
        ...
        useBulkUpdateMembers: useBulkUpdateMembersMutation,
